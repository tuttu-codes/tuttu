...
function templateInfo() {
  return stripIndents`
  <template_info>
    The Tuttu WebContainer environment starts with a full-stack app template fully loaded at '/home/project',
    ...
    <file path="convex/auth.ts">
      ...
      within Tuttu. They can download the code and do it themselves.
