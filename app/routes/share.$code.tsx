...
export const meta: MetaFunction<typeof loader> = ({ data }) => {
  ...
  const title = description ? `${description} ${authorText} | Tuttu` : `Shared Project ${authorText} | Tuttu`;
  const ogTitle = description || 'Shared Project';
  const ogDesc = `Built with Tuttu ${authorText}`;
  ...
  return [
    ...
    { property: 'og:site_name', content: 'Tuttu' },
    {
      property: 'og:image',
      content: thumbnailUrl || 'https://tuttu.convex.dev/social_preview_share.png',
    },
