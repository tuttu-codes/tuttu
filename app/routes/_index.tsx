...
export const meta: MetaFunction = () => {
  return [
    { title: 'Tuttu | No-code Full-Stack Web App Developer' },
    { name: 'description', content: 'Enter your prompt and watch Tuttu build your complete web application with database, auth, and real-time features' },
    {
      property: 'og:image',
