...
import { useTuttuAuth } from './TuttuAuthWrapper';
...
const HIGHLIGHTS: Highlight[] = [
  {
    text: 'ai chat',
    tooltip: 'Unless otherwise configured, Tuttu will prototype with GPT‑4o mini or GPT‑4.1 nano (limits apply).',
  },
  {
  ...
  },
  {
    ...
    tooltip: (
      <>
        Tuttu will use Convex’s built-in{' '}
  ...
  },
  {
    ...
    tooltip: (
      <>
        Tuttu will use the <TooltipLink href="https://www.convex.dev/components/presence">Presence</TooltipLink>{' '}
        Convex&nbsp;<TooltipLink href="https://www.convex.dev/components">component</TooltipLink>.
      </>
    ),
  },
      ...
      <div className="rounded-xl bg-background-primary/75 backdrop-blur-md">
        ...
        >
          ...
          <div className="ml-auto flex items-center gap-1">
            {tuttuAuthState.kind === 'unauthenticated' && <SignInButton />}
            {tuttuAuthState.kind === 'fullyLoggedIn' && (
              <MenuComponent
                buttonProps={{
                  variant: 'neutral',
              ...
              >
                <div className="ml-3 flex items-center gap-1">
                  ...
                  <Tooltip tip="Recipes are Tuttu prompts that add powerful full-stack features to your app." side="top">
            ...
            <Button
              disabled={
                ...
                !selectedTeamSlug ||
                tuttuAuthState.kind === 'loading' ||
                sendMessageInProgress ||
                disabled
              }
              tip={
                tuttuAuthState.kind === 'unauthenticated'
...
const CharacterWarning = memo(function CharacterWarning() {
  return (
    <Tooltip
      tip="Tuttu performs better with shorter prompts. Consider making your prompt more concise or breaking it into smaller chunks."
      side="bottom"
    >
