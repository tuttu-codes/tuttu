...
import { TuttuAuthProvider } from './chat/TuttuAuthWrapper';
...
function ExistingChatWrapper({ chatId }: { chatId: string }) {
  ...
  // Once we've loaded chat messages, let's wait on setting up the container.
    ...
    loading = 'Loading Tuttu environment...';
  }
  ...
  return (
    <div className="flex h-full flex-col items-center justify-center p-8 text-center">
      ...
      <p className="mb-4 text-balance text-content-secondary">
        The Tuttu project you’re looking for can’t be found. Maybe it was deleted or created with another account?
      </p>
      <a
        href="/"
