    ...
    <div className="my-12 flex max-w-chat flex-col">
      <div className="overflow-hidden rounded-lg border border-neutral-2 dark:border-neutral-10">
        <div className="flex items-center border-b border-neutral-2 bg-neutral-1/20 px-4 py-2 dark:border-neutral-10 dark:bg-neutral-11">
          <a
            href="https://github.com/get-convex/tuttu"
        ...
        <div className="flex flex-col gap-6 px-4 py-6 text-lg text-neutral-9 dark:text-neutral-2">
          <p>
            Tuttu is open-source, check out the GitHub repo{' '}
            <a
              href="https://github.com/get-convex/tuttu"
          ...
          <p>
            ...
            Tuttu, you can view or download the system prompt{' '}
            <a
              href="https://github.com/get-convex/tuttu/releases/latest"
              className="font-semibold text-bolt-elements-button-primary-backgroundHover hover:underline dark:text-white"
            >
              here
            </a>
          ...
          <p>
            As mentioned above, Tuttu&apos;s capabilities are enabled by being built on top of{' '}
            <a
              href="https://convex.dev"
              className="font-semibold text-bolt-elements-button-primary-backgroundHover hover:underline dark:text-white"
            >
            ...
            &ldquo;magic&rdquo; in Tuttu is just the fact that it&apos;s using Convex&apos;s APIs, which are an ideal fit
            for codegen.
          </p>
          <p>
            Development of the Tuttu is led by the Convex team. We{' '}
            <a
              href="https://github.com/get-convex/tuttu/blob/main/CONTRIBUTING.md"
              className="font-semibold text-bolt-elements-button-primary-backgroundHover hover:underline dark:text-white"
            >
              welcome bug fixes
            </a>{' '}
