          ...
          <div>
            {experience === 'marketing-page-only-for-mobile' ? (
              <>
                ...
                <p className="my-2">Tuttu supports desktop Firefox, Chrome, and some other Chromium-based browsers.</p>
              </>
            ) : experience === 'marketing-page-only-for-desktop-safari' ? (
              <>
                <h3 className="text-xl font-bold">You’re a few keystrokes away from cooking with Tuttu!</h3>
                <p className="my-2">
                  Tuttu uses{' '}
                  <a
                    href="https://webcontainers.io/guides/browser-support#web-platform-requirements"
