...
This is a project built with [Tuttu](https://tuttu.convex.dev) using [Convex](https://convex.dev) as its backend.
 You can find docs about Tuttu with useful information like how to deploy to production [here](https://docs.convex.dev/tuttu).
...
Tuttu apps use [Convex Auth](https://auth.convex.dev/) with Anonymous auth for easy sign in. You may wish to change this before deploying your app.
