...
import { calculateTotalBilledUsageForMessage, calculateTuttuTokens } from '~/lib/common/usage';
...
export async function recordUsage(
  ...
  const { tuttuTokens } = calculateTuttuTokens(totalUsageBilledFor, modelProvider);
  ...
  logger.info('Logging total usage', JSON.stringify(totalUsageBilledFor), 'corresponding to tuttu tokens', tuttuTokens);
