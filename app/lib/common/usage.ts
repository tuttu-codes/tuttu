...
export type TuttuTokenBreakdown = {
  completionTokens: {
    anthropic: number;
    openai: number;
    xai: number;
...
// https://www.notion.so/convex-dev/Tuttu-Pricing-1cfb57ff32ab80f5aa2ecf3420523e2f
export function calculateTuttuTokens(totalUsage: Usage, provider?: ProviderType) {
  let tuttuTokens = 0;
  const breakdown = {
    completionTokens: {
      anthropic: 0,
  ...
  if (provider === 'Anthropic') {
    ...
    tuttuTokens += cacheCreationInputTokens;
    ...
    tuttuTokens += cacheReadInputTokens;
    ...
    tuttuTokens += cacheWriteInputTokens;
    ...
    tuttuTokens += openaiCompletionTokens;
    ...
    tuttuTokens += openaiCachedPromptTokens;
    ...
    tuttuTokens += openaiUncachedPromptTokens;
    ...
    tuttuTokens += googlePromptTokens;
    ...
    tuttuTokens += googleCachedContentTokens;
